...
class Inscripciones extends DBAbstractModel {
    ...
    public function set($id_usuario = '', $user_data=[]){
        ...
        $this->query = "INSERT INTO inscripciones (solicitante, telefono, email, actividad_id, id_usuario, fecha_inscripcion, estado) 
                        VALUES (:solicitante, :telefono, :email, :actividad_id, :id_usuario, :fecha_inscripcion, :estado)";
        ...
        $this->mensaje = 'Inscripcion creada';
    }
