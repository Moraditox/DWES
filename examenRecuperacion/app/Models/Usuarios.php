...
class Usuarios extends DBAbstractModel
{
    ...
    {
        $this->query = "SELECT usuarios.* FROM usuarios INNER JOIN conductores ON conductores.id_usuario = usuarios.id";
        $this->get_results_from_query();
        return $this->rows;
    }
    ...
    public function login()
    {
        ...
        // Depurar la consulta y el parámetro
        var_dump($this->parametros['usuario']); // Verificar qué valor está recibiendo
        $this->get_results_from_query();
        return $this->rows[0] ?? null;
    }
    ...
    {
        $this->query = "SELECT * FROM conductores WHERE id_usuario = :id_usuario";
    ...
    {
        $this->query = "SELECT * FROM agentes WHERE id_usuario = :id_usuario";
        $this->parametros['id_usuario'] = $id;
        $this->get_results_from_query();
        return $this->rows[0] ?? null;
    }
    ...
    {
        $this->query = "SELECT * FROM personal_dgt WHERE id_usuario = :id_usuario";
        $this->parametros['id_usuario'] = $id;
        $this->get_results_from_query();
        return $this->rows[0] ?? null;
    }
