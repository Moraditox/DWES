...
class UsuarioController extends BaseController
{
    ...
    public function indexAction()
    {
        ...
        if ($_SESSION['perfil_usuario'] === 'conductor') {
            // Obtener multas del conductor
            $data['multasConductor'] = $multas->getMultasByConductor($_SESSION['user_id']);
        } elseif ($_SESSION['perfil_usuario'] === 'agente') {
            // Obtener multas registradas por el agente
            $data['multasAgente'] = $multas->getMultasByAgente($_SESSION['user_id']);
        }
    ...
    public function loginAction()
    {
        ...
        if (!empty($_POST)) {
            ...
            if (empty($data['errorUsuario']) && empty($data['errorPassword']) && empty($data['errorCaptcha'])) {
                ...
                $user = $usuarioModel->getByUsuario($data['usuario']);
